...
## Step 2: Treat roadmap/pending items as signal, not spec
...
continuity files. Do not fall back to the archived `docs/planning/CHECKLIST.md` as active sequencing.
